const  potionNameList = ['Elixir','Draught','Vial','Philter','Tonic','Brew','Ichor','Juice','Concoction']

const potionsEffects = [
...
const potionStrengths = ["Regular with a slight side effect.",
...
const potionAppearances = [
  ...
  "Steam rising",
  "Faintly glowing runes on the surface",
  "Tiny lightning bolts inside",
  "Shaped like a galaxy",
  "With a miniature storm inside",
  "Looking like ink in water",
  "Visibly alive",
  "Changing appearance constantly",
  "Shifting between solid and liquid",
  "Looks like a captured star",
  "Black void with no reflections",
  "Looks like it contains smoke",
  "Faintly pulsing light",
  "Changes color when moved",
  "Shimmering surface like oil on water",
  "With tiny fish swimming inside",
  "Floating shapes that move",
  "Swirling mist above the liquid",
  "Glows brighter in darkness",
  "Dimmer in daylight",
  "Hums with light",
  "Has a tiny rotating orb inside",
  "Suspended floating particles",
  "With a liquid mirror surface",
  "Moving independently of gravity",
  "Waves gently on its own",
  "Crackling sparks in the mix",
  "Forms eyes that blink occasionally",
  "Formless until touched",
  "Looks like glass but moves",
  "Illuminates nearby surfaces",
  "Reflects your face differently",
  "Looks like a crystal, but is liquid",
  "Shaped like a rose inside",
  "Filled with smoke-like tendrils",
  "Suddenly still if looked at directly",
  "Emits light shapes above it",
  "With snowflake-like particles",
  "Liquid shaped like a flame",
  "Tiny clouds form within",
  "Patterns resembling constellations",
  "Looks like swirling sand",
  "A fog trapped in a jar",
  "Looks like blood, thick and red",
  "Bright, neon-colored glow",
  "Glows with a heartbeat rhythm",
  "Ribbons of color spiraling inside",
  "With veins of color",
  "Glows in magical script",
  "Appears pixelated",
  "With geometric fractals",
  "Like stained glass in motion",
  "Glows only when touched",
  "Like melted gems",
  "Dim light like bioluminescence",
  "Flickers like a candle",
  "With a visible aura around it",
  "Spins endlessly when uncorked",
  "Misty surface like frost",
  "Fills with stars when shaken",
  "Looks like tears suspended",
  "Almost invisible",
  "Color so intense it hurts to look at",
  "Glowing cracks in the container",
  "With floating feathers inside",
  "With swirling leaves inside",
  "Looks like lava in water",
  "Always looks half-full",
  "Only visible at an angle",
  "Looks like flowing fabric",
  "Shimmers like heat haze",
  "Appears frozen in time",
  "Jittery and twitching",
  "Slowly dripping upwards",
  "Paint-like viscosity",
  "Seems to rotate inside",
  "Liquid shaped like a creature",
  "Contains floating bones",
  "With floating geometric shapes",
  "Changes color when named aloud",
  "Coalesces when you blink",
  "Smooth liquid with stars",
  "Looks like a foggy orb",
  "A cube of swirling mist",
  "Static flickers inside",
  "Seems filled with tiny gears",
  "With flickering shadows inside",
  "Like a crystal ball filled with rain",
  "With writing forming and vanishing"
];

const potionTextures = [
  "Thick and sludgy",
  "Thin and watery",
  "Airy and bubbly",
  "Slimey",
  ...
  "Mossy",
  "Brittle",
  "Rubbery with hard chunks",
  "Flickering like flame",
  "Shifting like smoke",
  "Vibrating softly",
  "Buzzing to the touch",
  "Soapy",
  "Crumbly with chunks",
  "Malleable like clay",
  "Sizzling slightly",
  ...
  "Sandy",
  "Writhing",
  "Snappy like pop rocks",
  "Slimy with resistance",
  "Dripping endlessly",
  "Expanding and contracting",
  "Iridescent and shifting",
  "Electric to the touch",
  "Static-charged",
  "Wet but never sticky",
  "Dry and flaky",
  "Crackling ice",
  "Fizzing with sparks",
  "Bouncy",
  ...
  "Chalky",
  "Mealy",
  "Gel-like with solid bits",
  "Melty",
  "Slippery and squirmy",
  "Humming with magic",
  "Serrated like a blade",
  "Feathery",
  "Threaded like webbing",
  "Twisting",
  "Warped",
  "Segmented",
  "Dense like metal",
  "Vaporous but heavy",
  "Crackling embers inside",
  "Pudding-thick",
  "Molten",
  "Bristly",
  "Flaking",
...
const potionLabels = [
  ...
  "A person's name. The potion won’t work unless asked by its name to do so.",
  "A strange prophecy.",
  "A small doodle.",
  ...
  "Saying it’s designed for babies.",
  "Saying that it shouldn’t be drank by children.",
...
function getColor()
{
  ...
  {
    return   `${getRandomItem(colorModifiers)} ${getRandomItem(potionColors)}`;
  }
  else
  {
    return   `${getRandomItem(potionColors)}`;

  }
}


async function buildPotion(tp) 
{

	let potionName = getRandomItem(potionNameList);
	let potionEffect = getRandomItem(potionsEffects);
	let potionSideEffect = getRandomItem(potionSideEffects);
	let potionsStrength = getRandomItem(potionStrengths);	
	let potionContainer = getRandomItem (potionContainers);
	let potionColor = getColor();
	let potionAppearance = getRandomItem(potionAppearances);
	let potionTexture = getRandomItem(potionTextures);
	let potionScent = getRandomItem(potionScentsAndTastes);
	let potionTaste = getRandomItem(potionScentsAndTastes);
	let potionLabel = getRandomItem(potionLabels);

	let split = potionEffect.split('.');

  await tp.file.rename(`${potionName} of ${split[0]} ${tp.date.now("DD-MM-YY")}`) 

	
	return `**${potionName} of ${split[0]}**\n\n` +
		`Contained in ${potionContainer.toLowerCase()} The potion has ${potionAppearance.toLowerCase()} and is ${potionColor.toLowerCase()} in color. It feels ${potionTexture.toLowerCase()} to the touch.\n\n` +
		`It smells like ${potionScent.toLowerCase()} and tastes like ${potionTaste.toLowerCase()}.\n\n` +
		`**Effect:** ${potionEffect}\n` +
		`**Side effect:** ${potionSideEffect}\n` +
		`**Strength:** ${potionsStrength}\n\n` +
		`**Label:** ${potionLabel}`;
}


module.exports = buildPotion;
