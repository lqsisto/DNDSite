...
"traits":
  - "desc": "Xeleth has advantage on saving throws it makes to avoid or end the [charmed](3-Mechanics/CLI/rules/conditions.md#Charmed)\
    ...
    "name": "Fey Ancestry"
  - "desc": "Xeleth wears a suit of [elven chain](3-Mechanics/CLI/items/elven-chain.md)."
...
"actions":
  ...
  - "desc": "Xeleth casts one of the following spells, using Intelligence as the spellcasting\
      \ ability:\n\n**1/day each:** [fly](3-Mechanics/CLI/spells/fly.md), [mislead](3-Mechanics/CLI/spells/mislead.md),\
