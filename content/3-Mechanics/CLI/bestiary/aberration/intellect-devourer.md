...
"traits":
  - "desc": "The intellect devourer can sense the presence and location of any creature\
      ...
      \ of interposing barriers, unless the creature is protected by a [mind blank](3-Mechanics/CLI/spells/mind-blank.md)\
      \ spell."
...
"actions":
  ...
  - "desc": "The intellect devourer initiates an Intelligence contest with an [incapacitated](3-Mechanics/CLI/rules/conditions.md#Incapacitated)\
      ...
      \ and good](3-Mechanics/CLI/spells/protection-from-evil-and-good.md). If it\
      \ wins the contest, the intellect devourer magically consumes the target's brain,\
      ...
      \ [wish](3-Mechanics/CLI/spells/wish.md). By spending 5 feet of its movement,\
